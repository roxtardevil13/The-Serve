...
public class Maid1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.maid_luxury);
        drawerLayout=findViewById( R.id.dllux );
        user();
        u.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Maid1.this, "You Required Maid on Urgent basis", Toast.LENGTH_SHORT).show();
        ...
        d.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(Maid1.this, "You Required Maid on Daily basis", Toast.LENGTH_SHORT).show();
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (m == null) {
                    Toast.makeText(Maid1.this, "Kindly select the requirement basis", Toast.LENGTH_SHORT).show();
                } else if (n.isEmpty() || e.isEmpty() || p.isEmpty() || a.isEmpty()) {
                    Toast.makeText(Maid1.this, "Kindly fill all the information fields", Toast.LENGTH_SHORT).show();
                }else{
                    Intent i = new Intent(Maid1.this, Payment.class);
                    i.putExtra("name", n);
                    i.putExtra("email", e);
                    i.putExtra("phone", p);
    ...
    private void user() {
        ...
        address=(EditText)findViewById(R.id.lAddress);
        u = (ImageView) findViewById(R.id.luxU);
        d = (ImageView) findViewById(R.id.luxD);
        b=(Button)findViewById(R.id.luxbutton);
